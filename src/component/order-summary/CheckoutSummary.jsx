    ...
    <div className="checkout-summary">
      ...
      <Item.Group divided>
        {cartItems.map((item) => {
          ...
          return (
            <Item key={item._id} className="px-2 m-0 py-2">
              <Item.Content>
              ...
              <Button.Group floated="right">
                <Button
                  icon
                  onClick={() => updateItemsHandler(item._id, "ADD")}
                >
                  <Icon name="add" />
                </Button>
                <Button basic icon>
                ...
                <Button icon>
                  <Icon
                    name="minus"
                    onClick={() => updateItemsHandler(item._id, "MINUS")}
                  />
                </Button>
              </Button.Group>
            </Item>
      ...
      <Table attached>
        <Table.Body>
          ...
          <Table.Row>
            <Table.Cell textAlign="right" className="h5">
              Grand Total
            </Table.Cell>
            <Table.Cell textAlign="center" className="h5 text-danger">
              ₹ {grandTotalCalculator(subtotal)}
            </Table.Cell>
          </Table.Row>
        </Table.Body>
      </Table> */}
